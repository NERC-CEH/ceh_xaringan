...
|                                                                                                            |                                   |
| :--------------------------------------------------------------------------------------------------------- | :-------------------------------- |
| <a href="mailto:plevy@ceh.ac.uk">.ScPored[<i class="fa fa-paper-plane fa-fw"></i>]               | plevy@ceh.ac.uk       |
| <a href="https://github.com/NERC-CEH/ceh_xaringan">.ScPored[<i class="fa fa-link fa-fw"></i>] | slides |
| <a href="http://twitter.com/UKCEH">.ScPored[<i class="fa fa-twitter fa-fw"></i>]                          | @UKCEH                         |
| <a href="http://github.com/NERC-CEH">.ScPored[<i class="fa fa-github fa-fw"></i>]                          | @NERC-CEH                       |
